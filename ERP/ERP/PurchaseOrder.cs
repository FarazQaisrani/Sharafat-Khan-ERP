...
namespace ERP
{
    public partial class PurchaseOrder : Form
    {
        ...
        private void POProduct_Load(object sender, EventArgs e)
        { 
            mc = new Myconnection();
            mc.conn.Open();
            //int c = 0;
        ...
        //    cmd = new OleDbCommand("select DDate from PO where POID = '"+txtid.Text+"' " , mc.conn);
        //    dr = cmd.ExecuteReader();
        //    if (dr.Read())
        //    {
        //       //string dt = txtdate.Text.ToShortDateString();
        //        //dateTimePicker1.Value.ToShortDateString()
        //            dt= dr["DDate"].ToString();
        //    }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PurchOrdApprove poa = new PurchOrdApprove();
            this.Hide();
            poa.ShowDialog();
        }
